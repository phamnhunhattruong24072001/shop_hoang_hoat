<x-admin-layout>
    <div class="page-content-wrapper">
        <div class="page-content">
            <!--breadcrumb-->
            @include('admin.inc.breadcrumb', ['title' => 'Danh mục', 'subtitle' => 'Thêm mới'])
            <!--end breadcrumb-->
            <div class="d-block pb-2">
                
            </div>
            <form action="{{ route('category.store') }}" autocomplete="off" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="slug" onkeyup="ChangeToSlug()" class="form-control @error('category_name') is-invalid @enderror" name="category_name" value="{{old('category_name')}}">
                                        @error('category_name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="convert_slug" class="form-control @error('category_slug') is-invalid @enderror" name="category_slug" value="{{old('category_slug')}}">
                                        @error('category_slug')
                                        ...
                                        <select name="category_parent_id" class="form-control" id="">
                                            ...
                                            @foreach ($categories as $cate)
                                                ...
                                                @foreach ($cate->parent as $child)
                                                    <option value="{{$cate->id}}">----{{$child->category_name}}</option>
                                                @endforeach
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body text-center">
                                    <div class="preview hide mb-3" id="image__preview">
                                        ...
                                        @else
                                            <img src="{{asset('thumbs/not-image.png')}}" height="100px" width="auto" alt="">
                                        @endif
                                    </div>
                                </div>
